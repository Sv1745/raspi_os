...
sudo pip3 install sqlalchemy==1.3.23 --break-system-packages
sudo pip install flask_sqlalchemy==2.5.1 --break-system-packages
sudo pip3 install flask-cors --break-system-packages
sudo pip3 install -U pymodbus==2.5.3 --break-system-packages
